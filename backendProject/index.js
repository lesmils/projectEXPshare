...
const liveEventRouter = require("./routers/liveEvents");
const onlineEventRouter = require("./routers/onlineEvents");
...
app.use("/liveevents", liveEventRouter);
app.use("/onlineevents", onlineEventRouter);
